...
class Clinic:
    def __init__(self, env, number_of_rooms, service_time, lambda_per_hour=14/60, seed=None):
    ...
    def generate_patients(self):
        def time_between_new_patients():
            ...
            #exp(1/lambda), zaokraglic do liczby calkowitej
    ...
    def serve_patient(self, patient):
        ...
        print(f"Czas {self.env.now}: Pacjent {patient.id} wychodzi z gabinetu {room.id}, czekal od {patient.arrival_time} do {patient.service_start_time}")
